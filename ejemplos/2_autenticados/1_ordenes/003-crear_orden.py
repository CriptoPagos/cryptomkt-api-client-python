...
print(Market.createBuyOrder(0.01, 1000)) # 0.01 ETH a 1.000 pesos cada 1 ETH
...
print(Market.createSellOrder(0.01, 100000000)) # 0.01 ETH a 100.000.000 pesos cada 1 ETH
